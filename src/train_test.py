...
for name, model in models:
    ...
    result = accuracy_score(prediction, testLabelsGlobal)
    results.append(result)
    names.append(name)
    msg = "%s: %f" % (name, result)
    print(msg)
    print(confusion_matrix(prediction, testLabelsGlobal))

# boxplot algorithm comparison
fig = pyplot.figure()
fig.suptitle('Machine Learning algorithm comparison 2')
